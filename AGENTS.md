...
@aget-version: 3.28.0
@aget-canonical-specs: https://github.com/aget-framework/aget/tree/v3.28.0/specs — reliance-only conformance
...
| Stream | Status | Note |
|--------|--------|------|
public-OpenAI-DeepResearch-aget (DeepThink) - Cognitive research agent - v3.21.0
...
See: L675 (consequence gap), L340 (execution governance), ADR-008 (Advisory → Strict)
